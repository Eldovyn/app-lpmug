...
$TR = [
    'id' => [
        'title_tab_default' => 'Luaran',
        'title_default'     => 'Luaran',
        ...
        'th_research_output' => 'Luaran Penelitian',
        'th_action'         => 'Action',
    ...
    'en' => [
        'title_tab_default' => 'Research Output',
        'title_default'     => 'Research Output',
        ...
        'th_research_output' => 'Research Output',
        'th_action'         => 'Action',
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><?= esc($title ?? $t('title_default')); ?></div>
        </div>
    </div>
    ...
    <div class="section-body">
        <div class="card">
            <div class="card-header">
                <h4 class="text-sm">
                    <a href="<?= site_url('luaran/new'); ?>" class="btn btn-primary">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?= esc($t('th_research_output')) ?></th>
                        ...
                        <tbody>
                            ...
                            $no = 1 + (10 * ($page - 1));
                            foreach ($luaran as $fgsi => $v_luaran):
                            ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= esc($v_luaran->luaran_name); ?></td>
                                    <td class="text-center">
                                        <a href="<?= site_url('luaran/' . $v_luaran->luaran_id . '/edit'); ?>" class="btn btn-warning btn-sm">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <form action="<?= site_url('luaran/' . $v_luaran->luaran_id); ?>" method="POST" class="d-inline" id="del-<?= (int) $v_luaran->luaran_id; ?>">
                                            <?= csrf_field(); ?>
                                            <input type="hidden" name="_method" value="DELETE">
                                            <button class="btn btn-danger btn-sm"
                                                data-confirm="<?= esc($t('delete_title')) ?> | <?= esc($t('delete_msg')) ?>"
                                                data-confirm-yes="submitDel(<?= (int) $v_luaran->luaran_id; ?>)">
