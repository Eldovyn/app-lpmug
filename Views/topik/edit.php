...
$TR = [
    ...
    'en' => [
        ...
        'example'        => 'example: Information Technology and Computing (ITC)',
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= site_url('topik/' . $topik->topik_id); ?>" method="POST" autocomplete="off">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="_method" value="PATCH">
                            <div class="form-group">
                                <label><?= esc($t('label_topic')) ?><small class="text-danger">*</small> (<?= esc($t('example')) ?>)</label>
                                <input type="text" name="topik_name" value="<?= esc($topik->topik_name); ?>" class="form-control" required autofocus>
                            </div>
                            <div class="text-right">
                                <a href="<?= site_url('topik'); ?>" class="btn btn-dark"><?= esc($t('back')) ?></a>
