...
$I18N = [
    ...
    'en' => [
        ...
        'labelNote'      => 'Contact name', // tetap sama “feel” label, kalau mau "Notes" tinggal ganti
                    ...
                    <div class="card-body">
                        <form action="<?= site_url('kontak'); ?>" method="POST" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kontak_name" class="form-control" required autofocus>
                            </div>
                            <div class="form-group">
                                <label><?= $__('labelContact'); ?><small class="text-danger">*</small> <?= $__('exampleContact'); ?></label>
                                <input type="number" name="kontak" class="form-control" required autofocus>
                            </div>
                            <div class="form-group">
                                <label><?= $__('labelNote'); ?><small class="text-danger">*</small></label>
                                <textarea name="keterangan" class="form-control" style="min-height:150px;"></textarea>
                            </div>
