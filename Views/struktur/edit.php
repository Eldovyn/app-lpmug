...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="<?= site_url('struktur'); ?>"><?= $__('dataStruktur'); ?></a></div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= site_url('struktur/' . $struktur->struktur_id); ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="_method" value="PATCH">
                            <div class="form-group">
                                <label><?= $__('title'); ?><small class="text-danger">*</small></label>
                                <input type="text" name="judul" value="<?= $struktur->judul; ?>" class="form-control <?= (session('validation')) ? 'is-invalid' : ''; ?>" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" class="summernote" style="min-height:150px;"><?= $struktur->deskripsi; ?></textarea>
                                <div class="invalid-feedback">
            ...
            <div class="col-12 col-md-6 col-lg-5">
                <div class="card">
                    <div class="card-body">
                        <img src="<?= base_url('/img/upload/struktur/' . $struktur->gambar); ?>" alt="struktur" class="w-100">
                    </div>
                </div>
            </div>
        </div>
