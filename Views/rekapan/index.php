...
$TR = [
    'id' => [
        ...
        'progress_need_1'       => 'Penilaian dari LPM',
        'progress_need_2'       => 'Upload laporan',
        'progress_need_3'       => 'Bukti Kegiatan',
        'progress_need_4'       => 'Link luaran',
    ...
    'en' => [
        ...
        'progress_monev_team'   => 'Team Review <br> Completed <br> (MonEv Team)',
        'progress_need'         => 'required:',
        'progress_need_1'       => 'LPM assessment',
        'progress_need_2'       => 'Upload report',
        'progress_need_3'       => 'Activity evidence',
        'progress_need_4'       => 'Output link',
        'progress_monev_lpm'    => 'Needs <br> LPM Review <br> (MonEv LPM)',
        ...
        'btn_invite' => 'Invitation Letter',
        'btn_delete' => 'Delete',
        'btn_monev'  => 'MonEv Score',
                                        ...
                                        <td>
                                            ...
                                            <?php elseif ($isMonevTeam): ?>
                                                ...
                                                <span class="text-dark text-small">
                                                    <?= esc($t('progress_need')); ?><br>
                                                    1. <?= esc($t('progress_need_1')); ?><br>
                                                    2. <?= esc($t('progress_need_2')); ?><br>
                                                    3. <?= esc($t('progress_need_3')); ?><br>
                                                    4. <?= esc($t('progress_need_4')); ?>
                                                </span>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if (!empty($v_abdimas->surat_undangan)) : ?>
                                                <a href="<?= site_url('berkas/undangan/' . $v_abdimas->surat_undangan); ?>" class="btn btn-info btn-sm p-1 mb-1" style="width:150px" target="_blank">
                                                    <i class="fas fa-eye mr-1"></i><?= esc($t('btn_invite')); ?>
                                                </a>
                                            <?php endif; ?>
