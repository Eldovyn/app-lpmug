                                        ...
                                        <td class="text-wrap">
                                            <?php foreach ($tags as $v_tags) :
                                                if ($v_abdimas->laporan_id == $v_tags->laporan_id && $v_tags->anggota_id == $v_abdimas->ketua_id) :
                                                    echo esc(ucwords(strtolower($v_tags->user_name))) . '<br> <b>NIDN:</b> ' . $v_tags->nidn . '<br> <b>SINTA ID</b>: ' . $v_tags->sinta_id . ' (<span class="text-danger">' . esc($t('leader')) . '</span>)';
                                                endif;
                                            endforeach; ?>
                                        </td>
