                    ...
                    <form action="<?= site_url('jurusan'); ?>" method="POST" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select name="fakultas_id" class="form-control select2" required>
                                ...
                                <?php foreach ($fakultas as $fk => $v_fakultas): ?>
                                    <option value="<?= $v_fakultas->fakultas_id; ?>"><?= $v_fakultas->fakultas_name; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Nama jurusan<small class="text-danger">*</small></label>
                            <input type="text" name="jurusan_name" class="form-control" required autofocus>
                        </div>
