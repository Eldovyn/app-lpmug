...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('template/assets/img/logo-gunadarma.png') ?>">
  ...
  <link rel="stylesheet" href="<?=base_url()?>template/assets/css/buttons.bootstrap4.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/summernote@0.8.11/dist/summernote-bs4.css">

  <!-- Template CSS -->
  <link rel="stylesheet" href="<?=base_url()?>template/assets/css/style.css">
  <link rel="stylesheet" href="<?=base_url()?>template/assets/css/components.css">
  <link rel="stylesheet" href="<?=base_url()?>template/assets/css/custom.css?v=<?= time() ?>">
</head>
