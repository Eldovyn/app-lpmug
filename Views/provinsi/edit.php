...
<div class="section-body">
    <div class="row">
        <div class="col-12 col-md-6 col-lg-7">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('provinsi/update/'.$provinsi->provinsi_id); ?>" method="POST" autocomplete="off">
                        <?= csrf_field(); ?>
                        <div class="form-group">
                            <label>Nama Provinsi<small class="text-danger">*</small></label>
                            <input type="text" name="provinsi_name" value="<?= $provinsi->provinsi_name; ?>"  class="form-control" required autofocus>
                        </div>
                        <div class="text-right">
                            <a href="<?= site_url('provinsi'); ?>" class="btn btn-dark">kembali</a>
