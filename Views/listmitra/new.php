...
<section class="section">
    <div class="section-header">
        <a href="<?= site_url('listmitra'); ?>" class="btn btn-dark mr-2"><i class="fas fa-arrow-left"></i></a>
        <h1><?= $title; ?></h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="<?= site_url('dashboard'); ?>"><?= esc($t['dashboard']); ?></a></div>
            <div class="breadcrumb-item active"><a href="<?= site_url('listmitra'); ?>"><?= esc($t['data_mitra']); ?></a></div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= site_url('listmitra'); ?>" method="POST" autocomplete="off">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group">
                                <label><?= esc($t['label_username']); ?><small class="text-danger">*</small> (<small class="text-primary"><?= esc($t['username_note']); ?></small>)</label>
                            ...
                            <div class="form-group">
                                <label><?= esc($t['label_email']); ?><small class="text-danger">*</small> (<small class="text-primary"><?= esc($t['email_note']); ?></small>)</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                            ...
                            <div class="form-group">
                                <label><?= esc($t['label_kontak']); ?><small class="text-danger">*</small> (<small class="text-primary"><?= esc($t['kontak_note']); ?></small>)</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i class="fas fa-phone"></i>
                            ...
                            <div class="form-group">
                                <label><?= esc($t['label_password']); ?><small class="text-danger">*</small></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
