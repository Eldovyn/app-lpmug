...
$TR = [
    'id' => [
        ...
        'th_functional' => 'jabatan fungsional',
        'th_action'     => 'Action',
    ...
    'en' => [
        ...
        'th_functional' => 'Functional position',
        'th_action'     => 'Action',
    ...
    <div class="section-body">
        <div class="card">
            <div class="card-header">
                <h4 class="text-sm">
                    <a href="<?= site_url('fungsional/new'); ?>" class="btn btn-primary"><i class="fas fa-plus-circle mr-1"></i><?= esc($t('add_data')) ?></a>
                    <!-- <a href="<?= site_url('fungsional/trash'); ?>" class="btn btn-danger"><i class="fas fa-trash mr-1"></i>Data yang dihapus</a> -->
                </h4>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $no = 1 + (10 * ($page - 1));
                            foreach ($fungsional as $fgsi => $v_fungsional):
                            ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= esc($v_fungsional->fungsional_name); ?></td>
                                    <td class="text-center">
                                        <a href="<?= site_url('fungsional/' . $v_fungsional->fungsional_id . '/edit'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                        <form action="<?= site_url('fungsional/' . $v_fungsional->fungsional_id); ?>" method="POST" class="d-inline" id="del-<?= (int) $v_fungsional->fungsional_id; ?>">
                                            <?= csrf_field(); ?>
                                            <input type="hidden" name="_method" value="DELETE">
                                            <button class="btn btn-danger btn-sm"
                                                data-confirm="<?= esc($t('delete_title')) ?> | <?= esc($t('delete_msg')) ?>"
                                                data-confirm-yes="submitDel(<?= (int) $v_fungsional->fungsional_id; ?>)">
